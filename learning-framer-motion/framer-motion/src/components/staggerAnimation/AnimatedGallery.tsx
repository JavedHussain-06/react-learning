  ...
  return (
    <div>
      <motion.button
        ...
        className="bg-yellow-400 text-black font-bold py-2 px-4 rounded shadow-sm shadow-orange-300 border-1 border-black mb-4 mx-auto block"
      >
      ...
      >
        {galleryImages.map((image, index) => (
          <motion.img
            ...
            className="ml-[2rem] w-[250px] rounded"
          />
        ))}
      </motion.div>
    </div>
